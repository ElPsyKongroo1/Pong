...
KARGONO_API void AddRaycastResultVec2Vec2(const std::string& funcName, std::function<Physics::RaycastResult(Math::vec2, Math::vec2)> funcPtr);
		KARGONO_API void Player2MoveUp(float parameter1);
		...
		KARGONO_API void Player2MoveDown(float parameter1);
		...
		KARGONO_API void TestScript99(uint64_t parameter1,float parameter2);
		KARGONO_API void OpenMainMenu();
		KARGONO_API void Player1MoveUp(float parameter1);
		KARGONO_API void OnConnectionTerminated();
		KARGONO_API void OpenPongGameplay();
		KARGONO_API void Player1OnCreate(uint64_t parameter1);
		KARGONO_API void Player1MoveDown(float parameter1);
		KARGONO_API void Player1OnUpdate(uint64_t parameter1,float parameter2);
		KARGONO_API void Player2OnCreate(uint64_t parameter1);
		KARGONO_API void Player2OnUpdate(uint64_t parameter1,float parameter2);
		KARGONO_API void BallOnCreate(uint64_t parameter1);
		KARGONO_API bool BallOfflineCollision(uint64_t parameter1,uint64_t parameter2);
		KARGONO_API void StartOnlineGame();
		KARGONO_API void OnReceiveSignal(uint16_t parameter1);
		KARGONO_API bool BallOnlineCollision(uint64_t currentEntity,uint16_t userSlot,uint64_t otherEntity);
		KARGONO_API bool BallOnPhysicsCollision(uint64_t parameter1,uint64_t parameter2);
		KARGONO_API bool BallOnPhysicsCollisionEnd(uint64_t parameter1,uint64_t parameter2);
