...
KARGONO_API void AddStringUInt64(const std::string& funcName, std::function<const std::string&(uint64_t)> funcPtr);
		...
		KARGONO_API void Player2MoveUp(uint64_t a,float b);
		...
		KARGONO_API void Player2MoveDown(uint64_t a,float b);
		...
		KARGONO_API void Player1MoveUp(uint64_t a,float b);
		...
		KARGONO_API void Player1MoveDown(uint64_t a,float b);
